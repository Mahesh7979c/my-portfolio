...
function Navbar({ setMode, mode }) {
  ...
  return (
    <>
      <nav className={`${mode === "dark" ? "" : ""} relative z-50`}>
        <div className="flex items-center justify-between h-[70px] md:mx-auto max-w-7xl px-4 sm:px-10 md:px-8 text-lg text-gray-700">
          ...
          <div className={`w-full md:flex md:items-center md:w-auto z-50 ${toggleNav ? "absolute top-16 -left-2 md:mx-auto max-w-7xl px-4 sm:px-10 pb-5 bg-[#f0f2f5]" : "hidden"}   ${toggleNav && mode === "dark" ? "bg-black" : ""}`} id="menu">
            <ul
              className={`
